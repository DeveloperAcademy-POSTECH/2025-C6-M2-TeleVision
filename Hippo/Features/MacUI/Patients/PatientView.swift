    ...
    NavigationSplitView(columnVisibility: $columnVisibility) {
        ...
        if viewModel.state.isLoading {
          ...
          Table(viewModel.state.items, selection: $selection) {
            ...
            TableColumn("Gender") { patient in
              Label(patient.gender, systemImage: patient.genderIcon)
                .foregroundStyle(.secondary)
            }
            .width(100)
      ...
      .toolbar {
        ToolbarItemGroup {
          ...
          Button {
            Task {
              guard let patientID = selection.first else { return }
      ...
      VStack(alignment: .leading, spacing: 20) {
        ...
        GroupBox("Patient Information") {
          VStack(alignment: .leading, spacing: 12) {
            ...
            InfoRow(label: "Birth Date", value: patient.birthDateText)
            InfoRow(label: "Last Updated", value: patient.updatedAtText)
          }
        }
                ...
                VStack(alignment: .leading, spacing: 4) {
                  HStack {
                    ...
                    Text(operation.status)
                      ...
                      .padding(.vertical, 4)
                      .background(Color(operation.statusColor).opacity(0.2))
                      .foregroundStyle(Color(operation.statusColor))
                      .cornerRadius(4)
                  }
