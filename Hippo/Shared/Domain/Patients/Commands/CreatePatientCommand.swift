...
/// Command object for creating a new patient
/// Encapsulates all required parameters with validation
public struct CreatePatientCommand: Sendable {
  public let patientNumber: String
  public let name: String
  public let gender: Gender
  public let birthDate: Date

  /// Creates a new patient command with validation
  /// - Parameters:
  ...
  /// Converts command to Patient entity
  /// - Returns: New Patient instance with generated UUID and timestamps
  public func toPatient() -> Patient {
    Patient(
      id: UUID().uuidString,
